...
public class PointsTableFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		ViewGroup root = (ViewGroup) inflater.inflate(R.layout.points_table,
				null);
		drawable = new getDrawable();
		lv = (ListView) root.findViewById(R.id.lstPointsTable);
		lv.setEnabled(false);
	...
	public int getDataFromDB() {
		...
		Cursor cur = db.rawQuery("select * from PointsTable", null);
