...
public class PurpleCapFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		ViewGroup root = (ViewGroup) inflater.inflate(R.layout.purple_cap, null);
		drawable = new getDrawable();
		lv = (ListView) root.findViewById(R.id.lstPurpleCap);
		lv.setEnabled(false);
